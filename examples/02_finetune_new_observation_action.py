...
python examples/02_finetune_new_observation_action.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=/root/autodl-tmp/aloha_sim_dataset/ --save_dir=/root/autodl-tmp/model/
"""
